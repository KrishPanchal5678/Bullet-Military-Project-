...
function setup() {
  ...
  thickness = random(150, 200);

  speed = random(100,200);
  weight = random(30, 40);

  speed2 = random(80,100);
  weight2 = random(50, 70);
  
  speed3 = random(110,200);
  weight3 = random(35, 45);
  
  speed4 = random(120,200);
  weight4 = random(40, 50);
 ...
 if(bullet.x === 2000) 
{
      ...
      wall.y - bullet.y <= wall.height/2 + bullet.height/2)
 {
   ...
   textSize(50)
   text(damage, 1500, 100)
   text(damage, 2350, 1000)

   if(damage < 0.10 && damage >0.05)
...
if(damage >= 0.10)
  ...
  if(bullet2.x - wall2.x <= wall2.width/2 + bullet2.width/2
    ...
    if(bullet2.x - wall2.x <= wall2.width/2 + bullet2.width/2
      ...
      wall2.y - bullet2.y <= wall2.height/2 + bullet2.height/2)
 {
  damage2 = (0.5 * weight2* speed2* speed2)/(thickness* thickness* thickness)
  
  textSize(50)
  text(damage2, 1500, 300)
  text(damage2, 2350, 1120)

  if(damage2 < 0.10 && damage2 >0.05)
...
if(damage2 >= 0.10)
  ...
  if(bullet3.x - wall3.x <= wall3.width/2 + bullet3.width/2
    ...
    if(bullet3.x - wall3.x <= wall3.width/2 + bullet3.width/2
      ...
      wall3.y - bullet3.y <= wall3.height/2 + bullet3.height/2)
 {
  damage3 = (0.5 * weight3* speed3* speed3)/(thickness* thickness* thickness)
  
  textSize(50)
  text(damage3, 1500, 500)
  text(damage3, 2350, 1240)

  if(damage3 < 0.10 && damage3 >0.05)
  ...
  if(bullet4.x - wall4.x <= wall4.width/2 + bullet4.width/2
    ...
    wall4.y - bullet4.y <= wall4.height/2 + bullet4.height/2)
    {
     ...
     if(bullet4.x - wall4.x <= wall4.width/2 + bullet4.width/2
      ...
      {
        damage4 = (0.5 * weight4* speed4* speed4)/(thickness* thickness* thickness)
  
        textSize(50)
        text(damage4, 1500, 700)
        text(damage4, 2350, 1360)
     
        if(damage4 < 0.10 && damage4 >0.05)
